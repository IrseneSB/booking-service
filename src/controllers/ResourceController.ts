...
export class ResourceController {
  ...
  async block(req: BunRequest<"/resources/:id/block">, user: DecodedToken): Promise<Response> {
    const id = Number(req.params.id);
  ...
  async unblock(req: BunRequest<"/resources/:id/unblock">, user: DecodedToken): Promise<Response> {
    const id = Number(req.params.id);
